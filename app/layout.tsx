...
function buildWidget(){
  ...
  btn.style.cssText='position:fixed;bottom:'+(isMob?'calc(72px + env(safe-area-inset-bottom, 0px))':'24px')+';left:'+(isMob?'12px':'24px')+';width:'+(isMob?'28px':'50px')+';height:'+(isMob?'28px':'50px')+';border-radius:50%;background:#0f0b0e;border:2px solid '+(active?'#C4857A':'rgba(196,133,122,0.35)')+';color:#C4857A;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:9990;box-shadow:'+(active?'0 4px 20px rgba(196,133,122,0.3)':'0 4px 16px rgba(0,0,0,0.5)')+';transition:border-color .2s,box-shadow .2s;padding:0;flex-shrink:0';
  ...
  panel.style.cssText='display:none;position:fixed;bottom:'+(isMob?'calc(108px + env(safe-area-inset-bottom, 0px))':'86px')+';left:'+(isMob?'8px':'24px')+';width:'+(isMob?'min(310px,calc(100vw - 16px))':'310px')+';max-height:82vh;overflow-y:auto;background:#fff;border-radius:18px;box-shadow:0 12px 48px rgba(0,0,0,0.35),0 2px 8px rgba(0,0,0,0.2);z-index:9991;font-family:Heebo,system-ui,sans-serif;transition:width .2s ease';
